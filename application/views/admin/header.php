	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			<li class="nav-item active">
				...
				dashboard')?>">Dashboard <span class="sr-only">(current)
					</span></a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="<?php echo site_url('admin/status')?>">status</a>
			</li>
			<li class="nav-item " dropdown>
				<a id="link" class="nav-link" href="<?php echo site_url('admin/dashboard/logout')?>" aria-controls="your-dropdown">
					Logout
				</a>
			</li>
		</ul>
